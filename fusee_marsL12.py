...
def generer_solution(incident):
    solutions = {
        "Légère fluctuation dans les moteurs": [
            ...
            "Réinitialisation du système de contrôle des moteurs",
            "Vérification des capteurs de pression et de température",
            "Diagnostic des composants du système de propulsion"
        ],
        "Petite variation de trajectoire détectée": [
            ...
            "Analyse des données de navigation pour identifier la cause",
            "Activation du système de correction de trajectoire automatique",
        ...
        "Pic de température dans le système de refroidissement": [
            ...
            "Analyse des données de refroidissement pour identifier la cause"
        ],
        "Brève perturbation dans les communications": [
            ...
            "Diagnostic des composants du système de communication",
            "Surveillance continue des communications"
        ],
        "Microfissure détectée dans un réservoir secondaire": [
            ...
            "Diagnostic des composants du système de stockage de carburant",
            "Analyse des données de pressurisation pour identifier la cause"
        ],
        "Dysfonctionnement mineur dans le système de navigation": [
            ...
            "Diagnostic des composants du système de navigation",
            "Surveillance continue de la navigation"
        ],
        "Défaillance partielle des panneaux solaires": [
            ...
            "Analyse des données de production d'énergie pour identifier la cause"
        ],
        "Problème dans le système de recyclage de l'air": [
            ...
            "Diagnostic des composants du système de recyclage de l'air",
        ...
        "Dysfonctionnement du système de contrôle thermique": [
            ...
            "Analyse des données de contrôle thermique pour identifier la cause"
        ],
        "Interférence électromagnétique": [
            ...
            "Diagnostic des composants du système de communication",
            "Surveillance continue des interférences électromagnétiques"
        ],
        "Perte de pressurisation dans un compartiment": [
            "Activation du système de pressurisation de secours",
            "Isolation du compartiment concerné",
            "Surveillance des niveaux de pressurisation",
            "Diagnostic des composants du système de pressurisation",
            "Analyse des données de pressurisation pour identifier la cause"
        ],
        "Défaillance d'un système de secours": [
            "Activation du système de secours redondant",
            "Diagnostic des composants du système de secours",
            "Analyse des données de fonctionnement pour identifier la cause",
            "Surveillance continue du système de secours"
        ],
